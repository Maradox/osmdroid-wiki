...
## From version 5.6.5 to 6.0 (under dev)

- If you were previously using the geopackage support library, several of the class and packages names were changed. Impacts should be minimal
